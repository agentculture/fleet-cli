...
Every failure inside fleet-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`fleet.cli._output`,
...
# Exit-code policy. Documented in ``fleet-cli learn`` output.
# 0      = success
