...
from fleet.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/fleet-cli/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    from fleet.cli._commands import cli as _cli_group
    from fleet.cli._commands import doctor as _doctor_cmd
    from fleet.cli._commands import explain as _explain_cmd
    from fleet.cli._commands import learn as _learn_cmd
    from fleet.cli._commands import overview as _overview_cmd
    from fleet.cli._commands import whoami as _whoami_cmd

    parser = _CliArgumentParser(
        prog="fleet-cli",
        description="fleet-cli — a clonable template for AgentCulture mesh agents.",
    )
    parser.add_argument(
        "--version",
        action="version",
    ...
    #   from fleet.cli._commands import my_noun as _my_noun_group
